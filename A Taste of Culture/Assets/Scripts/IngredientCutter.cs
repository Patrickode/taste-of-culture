...
public class IngredientCutter : MonoBehaviour
{
    ...
    public void CutIngredient(Vector2 cutStart, Vector2 cutEnd, GameObject ingredient)
    {
        ...
        float leftHalfScale = Vector2.Distance(colliderBounds.min, center);
        ...
        float rightHalfScale = Vector2.Distance(colliderBounds.max, center);
        ...
        bool cutDrawnSuccessfully = RepresentCut(center, colliderBounds.size.y + 1f);
