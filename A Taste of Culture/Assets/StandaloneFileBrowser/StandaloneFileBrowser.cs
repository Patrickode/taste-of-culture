...
namespace SFB
{
    ...
    public class StandaloneFileBrowser
    {
        ...
        /// <remarks>New overload written by Patrick Mitchell @ <see href="https://patrickode.github.io/"/> for a 
        /// singular extension filter</remarks>
        /// <param name="extFilter">Filter Example: new ExtensionFilter("Image Files", "jpg", "png")</param>
        /// <inheritdoc cref="SaveFilePanel(string, string, string, ExtensionFilter[])"/>
        public static string SaveFilePanel(string title, string directory, string defaultName, ExtensionFilter extFilter)
        {
            return SaveFilePanel(title, directory, defaultName, new[] { extFilter });
        }
